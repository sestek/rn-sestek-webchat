...
function init(config: { sampleRate: any; }) {
...
function mergeBuffers(recBuffers: string | any[], recLength: number | Iterable<number>) {
...
function floatTo16BitPCM(output: DataView, offset: number, input: string | any[]) {
