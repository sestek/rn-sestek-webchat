...
module.exports = function (styles: { [x: string]: any; autolink: any; blockQuoteSectionBar: boolean | ViewStyle | RegisteredStyle<ViewStyle> | RecursiveArray<Falsy | ViewStyle | RegisteredStyle<ViewStyle>> | readonly (Falsy | ViewStyle | RegisteredStyle<ViewStyle>)[] | null | undefined; blockQuoteBar: boolean | ViewStyle | RegisteredStyle<ViewStyle> | RecursiveArray<Falsy | ViewStyle | RegisteredStyle<ViewStyle>> | readonly (Falsy | ViewStyle | RegisteredStyle<ViewStyle>)[] | null | undefined; blockQuoteText: boolean | ViewStyle | RegisteredStyle<ViewStyle> | RecursiveArray<Falsy | ViewStyle | RegisteredStyle<ViewStyle>> | readonly (Falsy | ViewStyle | RegisteredStyle<ViewStyle>)[] | null | undefined; blockQuoteSection: boolean | ViewStyle | RegisteredStyle<ViewStyle> | RecursiveArray<Falsy | ViewStyle | RegisteredStyle<ViewStyle>> | readonly (Falsy | ViewStyle | RegisteredStyle<ViewStyle>)[] | null | undefined; br: any; codeBlock: any; del: any; em: any; hr: any; image: any; imageBox: any; inlineCode: any; listItemNumber: any; listItemBullet: any; listItemText: boolean | TextStyle | RegisteredStyle<TextStyle> | RecursiveArray<Falsy | TextStyle | RegisteredStyle<TextStyle>> | readonly (Falsy | TextStyle | RegisteredStyle<TextStyle>)[] | null | undefined; listRow: any; list: any; listItem: any; sublist: any; mailto: any; newline: any; paragraph: any; paragraphWithImage: any; paragraphCenter: any; noMargin: any; strong: any; tableHeaderCell: any; tableHeader: any; tableRowCell: any; tableRow: any; tableRowLast: any; table: any; text: any; u: any; }, opts = {}) {
    ...
    return {
        autolink: {
            react: function (node: { target: any; content: any; }, output: (arg0: any, arg1: { [x: string]: any; }) => boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined, { ...state }: any) {
        ...
        blockQuote: {
            react: function (node: { content: any; }, output: (arg0: any, arg1: { [x: string]: any; }) => boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined, { ...state }: any) {
        ...
        codeBlock: {
            react: function (node: { content: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined; }, output: any, { ...state }: any) {
                state.withinText = true;
                return React.createElement(Text, {
                    key: state.key,
        ...
        heading: {
            ...
            react: function (node: { level: string; content: any; }, output: (arg0: any, arg1: { [x: string]: any; }) => boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined, { ...state }: any) {
        ...
        list: {
            react: function (node: { items: any; ordered: any; }, output: (arg0: any, arg1: { [x: string]: any; }) => any, { ...state }: any) {
                var numberIndex = 1;
        ...
        paragraph: {
            react: function (node: { content: string | object | null | undefined; }, output: (arg0: any, arg1: { [x: string]: any; }) => {} | null | undefined, { ...state }: any) {
        ...
        table: {
            react: function (node: { header: any; cells: string | any[]; }, output: (arg0: any, arg1: { [x: string]: any; }) => {} | null | undefined, { ...state }: any) {
